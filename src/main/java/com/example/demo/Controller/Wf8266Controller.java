...
public class Wf8266Controller {
	...
	/** Autocomplete **/
	@GetMapping(value = "/autocomplete/getAllWf8266Detail", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ResponseEntity<Object> getAllWf8266Detail(Long locationId, String name) {
		...
		// 若沒有傳入 locationId 則回 204 No Content
		if (locationId == null) {
